...
// fetch refactoring
// biar lebih rapi, lebih terstruktur dan lebih mudah dibaca
// pemanfaatan async await untuk merapikan codingan
...
// ketika tombol detail di klik
// pakai cara event binding >> ngasih event ke elemen yang awalnya belum ada tapi ketika dia ada event nya tetap bisa berjalan
...
function getMovieDetail(imdbid) {
    return fetch('http://www.omdbapi.com/?apikey=91d09eeb&i=' + imdbid)
            .then(response => response.json())
            .then(m => m);
}
...
function getMovies(keyword) {
    return fetch('http://www.omdbapi.com/?apikey=91d09eeb&s=' + keyword)
            .then(response => response.json())
